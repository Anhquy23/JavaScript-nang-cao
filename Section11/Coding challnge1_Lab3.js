/*
Julia và Kate đang nghiên cứu về loài chó. Vì vậy, mỗi người trong số họ đã hỏi 5 chủ sở hữu chó về tuổi của con chó của họ và lưu trữ dữ liệu vào một mảng (một mảng cho mỗi người). Hiện tại, họ chỉ quan tâm đến việc biết một con chó là trưởng thành hay chó con. Chó được coi là trưởng thành nếu ít nhất 3 tuổi và là chó con nếu chưa đầy 3 tuổi.
Tạo một hàm 'checkDogs', hàm này chấp nhận 2 mảng tuổi của chó ('dogsJulia' và 'dogsKate') và thực hiện những việc sau:
