/* 
Julia và Kate đang học về loài chó, và lần này họ đang học xem sẽ ra sao nếu chó ăn quá nhiều hoặc quá ít.Ăn quá nhiều đồng nghĩa với phần ăn của chó lớn hơn mức khẩu phần khuyến nghị và ngược lại nếu ăn quá ít Khẩu phần ăn hợp lý là lớn hơn hoặc nhỏ hơn không vượt quá 10% khẩu phần ăn
khuyến nghị
TEST DATA:
const dogs = [
...
// 1. Lặp mảng gồm các object là thông tin của những chú chó, và với mỗi chú chó,thêm 1 thuộc tính mới vào object là khẩu phẩn ăn hợp lý (recommended). KHÔNG TẠO THÊM MẢNG MỚI, chỉ đơn giản là lặp mảng. Công thức: recommendedFood= weight ** 0.75 * 28. (kết quả là khổi lượng thức ăn đượ tính theo gram, và cân nặng của chú chó được tính theo kg)
